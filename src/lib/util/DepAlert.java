...
public class DepAlert extends Alert {
    ...
    public DepAlert(AlertType alertType) {
        super(alertType);
        init();
    }

    public DepAlert(AlertType alertType, String contentText, String headerText,  String title, ButtonType... buttons) {
    ...
    public DepAlert(AlertType alertType, String contentText,  String title, ButtonType... buttons) {
        super(alertType, contentText, buttons);
        setTitle(title);
        setHeaderText(title);
        init();
    ...
    public DepAlert(AlertType alertType, String contentText, ButtonType... buttons) {
        super(alertType, contentText, buttons);
        init();
    }
